...
import '../scene/scene_contract.dart';
import '../scene/venue_3d_controller.dart';
import '../scene/venue_3d_surface.dart';
...
class GameScreen extends StatefulWidget {
  const GameScreen({super.key, required this.controller, this.sceneFactory});

  final GameController controller;
  final SceneVenueFactory? sceneFactory;
...
class _GameScreenState extends State<GameScreen> {
  late final Venue3DController _scene;
            ...
            return ColoredBox(
              ...
              child: Stack(
                children: [
                  ...
                  if (wideViewport && !_developmentOpen && !_settingsOpen)
                    Positioned(
                      right: 12,
                      bottom: 12,
  ...
  void _selectRoom(RoomId? roomId) {
    ...
    _scene.setFocus(SceneVenueRoom.fromRoom(roomId));
  }

  void _selectSceneVenue(SceneVenue venue) {
    setState(() => _selectedRoom = venue.roomId);
    _scene.setFocus(venue.roomId == null ? null : venue);
  }
            ...
            child: GamePanel(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SectionEyebrow('Flutter 3D', color: GameColors.gold),
                  const Text(
                    'HOPS & HONEY',
                    textAlign: TextAlign.center,
                    style: TextStyle(
