...
final Map<RoomId, RoomLayout> roomLayouts = Map.unmodifiable({
  RoomId.karaoke: RoomLayout(
    center: const Vec2(-12.2, 1.5),
    size: const Vec2(8, 7.2),
    connectionSide: 'east',
    barPortal: const Vec2(-7.55, 1.5),
    roomPortal: const Vec2(-8.55, 1.5),
    guestSpots: const [
      Vec2(-10.35, 1.2),
      Vec2(-12.15, 1.35),
      Vec2(-13.95, 1.5),
  ...
  RoomId.sauna: RoomLayout(
    center: const Vec2(12.2, 1),
    size: const Vec2(8, 7.2),
    connectionSide: 'west',
    barPortal: const Vec2(7.55, 1),
    roomPortal: const Vec2(8.55, 1),
    guestSpots: const [
      Vec2(10.15, 1.45),
      Vec2(11.5, 1.6),
      Vec2(12.85, 1.55),
  ...
  RoomId.massage: RoomLayout(
    center: const Vec2(4.2, -9.8),
    size: const Vec2(8, 7.2),
    connectionSide: 'south',
    barPortal: const Vec2(4.8, -5.55),
    roomPortal: const Vec2(4.8, -6.55),
    guestSpots: const [Vec2(2.4, -8.25), Vec2(6, -8.25)],
  ),
});
