...
OUT = Path(r"C:\Users\hebp\AppData\Roaming\StabilityMatrix\Images\Text2Img\Tigra_2026\oral_poses")
PREFIX_DIR = "Tigra_2026/oral_poses"
...
SHOTS = [
    (
        ...
        "black sports bra, black crop top, black choker, bottomless",
...
def main():
    ...
    for i, (key, scene, extra_neg, seed) in enumerate(shots, start=1):
        prefix = f"{PREFIX_DIR}/op{i:02d}_{key}"
