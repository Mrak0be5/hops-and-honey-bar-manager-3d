...
OUT = Path(r"C:\Users\hebp\AppData\Roaming\StabilityMatrix\Images\Text2Img\Tigra_2026\oral_restore")
PREFIX_DIR = "Tigra_2026/oral_restore"
...
def main():
    ...
    for i, (key, scene, seed) in enumerate(SHOTS, start=1):
        prefix = f"{PREFIX_DIR}/rs{i:02d}_{key}"
