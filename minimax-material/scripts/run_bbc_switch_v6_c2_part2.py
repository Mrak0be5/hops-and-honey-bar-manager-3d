...
PROMPT = Path(__file__).resolve().parents[1].joinpath(
    "prompts", "wan30-bbc-switch-minimax-v6-c2-part2.txt"
...
wf["200"]["inputs"]["image"] = "mcp/v6-c2-part1-last.jpg"
...
wf.pop("23", None)
wf["92"]["inputs"]["filename_prefix"] = "video/tigra_bbc_switch_v6_c2_part2_5s"
wf["93"] = {
    ...
    "inputs": {
        ...
        "frame_rate": 24.0,
        "loop_count": 0,
        "filename_prefix": "video/tigra_bbc_switch_v6_c2_part2_5s_vhs",
