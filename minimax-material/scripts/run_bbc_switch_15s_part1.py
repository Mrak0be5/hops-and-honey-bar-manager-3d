...
PROMPT = Path(__file__).resolve().parents[1].joinpath(
    "prompts", "wan30-bbc-switch-minimax-15s-part1.txt"
...
wf = {
    ...
    "92": {
        ...
        "inputs": {
            "video": ["91", 0],
            "filename_prefix": "video/tigra_bbc_switch_15s_part1_10s",
            "format": "auto",
            "codec": "auto",
        },
    },
    "93": {
        ...
        "inputs": {
            ...
            "frame_rate": 24.0,
            "loop_count": 0,
            "filename_prefix": "video/tigra_bbc_switch_15s_part1_10s_vhs",
