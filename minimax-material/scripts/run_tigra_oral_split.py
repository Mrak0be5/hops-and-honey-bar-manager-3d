...
OUT = Path(r"C:\Users\hebp\AppData\Roaming\StabilityMatrix\Images\Text2Img\Tigra_2026\oral_split")
PREFIX_DIR = "Tigra_2026/oral_split"
...
NEG_BASE = (
    ...
    "male tail, stripes on the man, orange fur on the man, male muzzle, male tiger ears, "
...
def main():
    ...
    for i, (key, scene, extra_neg, seed) in enumerate(SHOTS, start=1):
        prefix = f"{PREFIX_DIR}/os{i:02d}_{key}"
