...
PROMPT = Path(__file__).resolve().parents[1].joinpath(
    "prompts", "wan30-bbc-switch-minimax-v5-c2-part1.txt"
...
wf["200"]["inputs"]["image"] = "mcp/c1-last.jpg"
...
wf.pop("23", None)
wf["92"]["inputs"]["filename_prefix"] = "video/tigra_bbc_switch_v5_c2_part1_10s"
wf["93"] = {
    ...
    "inputs": {
        ...
        "frame_rate": 24.0,
        "loop_count": 0,
        "filename_prefix": "video/tigra_bbc_switch_v5_c2_part1_10s_vhs",
