...
OUT = Path(r"C:\Users\hebp\AppData\Roaming\StabilityMatrix\Images\Text2Img\Tigra_2026\oral_human")
PREFIX_DIR = "Tigra_2026/oral_human"
...
HUMAN = (
    "human male, human man, pale human skin, hairless human body, human legs, human feet, "
    "human penis, no fur on the male"
)
...
NEG_BASE = (
    ...
    "(male tiger:1.8), (anthro male:1.8), (furry male:1.8), (two tigers:1.6), "
    "stripes on male, orange fur on male, male muzzle, male tiger ears, "
    "digitigrade male, paw feet on male, furry legs, "
    "covered breasts, sports bra on breasts, "
...
SHOTS = [
    (
        "lying_back",
        "in a gym, fitness center, lying on back, supine on gym mat, on her back, "
        "human male kneeling over her face, fellatio, deepthroat, looking up",
        "kneeling on knees, sitting on bench, standing pose, all fours",
        1202101,
    ),
    (
        "standing",
        "in a gym, fitness center, standing, both standing, standing fellatio, "
        "tigress standing with knees slightly bent, leaning forward a little, "
        "human male standing, fellatio, deepthroat, full body",
        "kneeling, sitting, lying down, on a bench, on the floor",
        1202102,
    ),
    (
        "sitting",
        "in a gym, sitting on gym bench, seated, buttocks on the bench, sitting pose, "
        "not kneeling, leaning forward from a seated position, fellatio, deepthroat, "
        "human male standing in front of the bench, side view",
        "kneeling, on the floor, lying down, standing tigress",
        1202103,
    ),
    (
        "upside_down",
        "in a gym, lying on a weight bench, head hanging off the edge of the bench, "
        "upside-down, inverted, head down, throat from above, fellatio, deepthroat, "
        "human male standing at the head of the bench",
        "kneeling on the floor, sitting upright, standing tigress, all fours",
        1202104,
    ),
    (
        "lying_side",
        "in a gym, lying on side on gym mat, recumbent, side-lying, profile view, "
        "fellatio, deepthroat, human male kneeling beside her",
        "kneeling upright, sitting on bench, standing, on her back, upside-down",
        1202105,
    ),
    (
        "lying_stomach",
        "in a gym, lying on her stomach, prone on gym mat, head at the end of the mat, "
        "fellatio, deepthroat, human male standing at her head, profile",
        "kneeling upright, sitting on bench, standing tigress, on her back, upside-down, all fours",
        1202106,
    ),
]
...
def main():
    ...
    for i, (key, scene, extra_neg, seed) in enumerate(SHOTS, start=1):
        prefix = f"{PREFIX_DIR}/oh{i:02d}_{key}"
