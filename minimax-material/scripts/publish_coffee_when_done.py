...
video_path = r"C:\Users\hebp\AppData\Roaming\StabilityMatrix\Packages\ComfyUI\output\video\tigra_coffee_anal_ref2va_nonturbo_00001_.mp4"
...
cmd = [
    ...
    "--image", video_path, 
    "--title", "Bored Coffee Anal (Ref2VA Non-Turbo 15s)", 
    "--category", "video", 
    "--push"
]
