...
OUT = Path(r"C:\Users\hebp\AppData\Roaming\StabilityMatrix\Images\Text2Img\Tigra_2026\gym_batch_600_v2")
...
def generate_batch(act, total_count):
    ...
    for start in range(1, total_count + 1, chunk_size):
        ...
        for i in range(start, end):
            ...
            prefix = f"Tigra_2026/gym_batch_600_v2/{act}/{act}_t{i:03d}_{pose}"
        ...
        sub = COMFY_OUT / "Tigra_2026" / "gym_batch_600_v2" / act
        if sub.exists():
...
def main():
    ...
    print("Starting V2 300 Anal generation...")
    generate_batch("anal", 300)
    print("Starting V2 300 Oral generation...")
