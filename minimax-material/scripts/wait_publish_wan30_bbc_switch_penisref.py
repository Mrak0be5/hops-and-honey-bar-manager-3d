...
video_path = r"C:\Users\hebp\AppData\Roaming\StabilityMatrix\Packages\ComfyUI\output\video\tigra_wan30_bbc_switch_ref2va_nonturbo_penisref_v2dark_00001_.mp4"
gallery_dir = r"C:\Users\hebp\galleries\tigress-thread-gallery"
prompt_file = r"C:\Users\hebp\OneDrive\Desktop\manager\hops-and-honey-bar-manager-3d\minimax-material\prompts\wan30-bbc-switch-minimax-penisref-v2.txt"
...
cmd = [
    ...
    video_path,
    "--title",
    "MiniMax Ref2VA 10s — bbc-switch penisref v2 (BBC dark + larger)",
    "--category",
    "video",
    "--model",
    "MiniMax-H3 Ref2VA Non-Turbo",
    "--note",
    "v2: Pic4 shape for bearded pale penis. Black man same shape, larger, dark skin on penis not pale from Pic4.",
    "--prompt-file",
    prompt_file,
    "--ref",
