...
OUT = Path(r"C:\Users\hebp\AppData\Roaming\StabilityMatrix\Images\Text2Img\Tigra_2026\gym_batch_600_v4")
...
def generate_batch(act, total_count):
    ...
    for start in range(1, total_count + 1, chunk_size):
        ...
        for i in range(start, end):
            ...
            prefix = f"Tigra_2026/gym_batch_600_v4/{act}/{act}_t{i:03d}_{pose}"
        ...
        sub = COMFY_OUT / "Tigra_2026" / "gym_batch_600_v4" / act
        if sub.exists():
...
def main():
    ...
    print("Starting V4 300 Anal generation...")
    generate_batch("anal", 300)
    print("Starting V4 300 Oral generation...")
    generate_batch("oral", 300)
    print("All 600 V4 images completed.")
