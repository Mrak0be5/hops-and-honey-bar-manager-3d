...
# We are switching to Ref2VA to handle multiple references (scene + penis + male character)
# Since the base workflow is FL2VA, we need to completely reconstruct the dictionary for Ref2VA.
# Luckily, I have the Ref2VA template from previous runs.
...
ref2va_wf = {
    ...
    "9": {
      ...
      "inputs": {
        "scheduler": "simple",
        "steps": 30,  # Non-turbo standard steps
        "denoise": 1.0,
        "model": ["6", 0]
      }
    },
    ...
    "92": {
      ...
      "inputs": {
        "video": ["91", 0],
        "filename_prefix": "video/tigra_part1_10s_ref2va_nonturbo",
        "format": "auto",
        "codec": "auto"
      }
    },
