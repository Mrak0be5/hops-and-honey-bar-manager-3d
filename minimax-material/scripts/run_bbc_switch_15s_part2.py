...
PROMPT = Path(__file__).resolve().parents[1].joinpath(
    "prompts", "wan30-bbc-switch-minimax-15s-part2.txt"
...
wf.pop("23", None)
wf["92"]["inputs"]["filename_prefix"] = "video/tigra_bbc_switch_15s_part2_5s"
wf["93"] = {
    ...
    "inputs": {
        ...
        "frame_rate": 24.0,
        "loop_count": 0,
        "filename_prefix": "video/tigra_bbc_switch_15s_part2_5s_vhs",
